...
//  2026.05~07 신규(웹 검증, docs/copy-refresh.md 리서치 참고):
//    거제 야호(반가움 표현), 파라파라("모르겠고 ~나 해야겠다" 리듬 패러디),
//    코 때리고 미안해하는 챌린지(실수→가볍게 웃어넘김), 쑥스바겐(쑥스럽다 말장난).
//  럭키비키(원영적 사고)는 2026.02 기준 이미 "유행 지났다"고 명시한 출처가 있어
//  전량 삭제함 — 새로 쓰지 말 것.
...
class DailyQuotes {
  ...
  static const Map<String, List<String>> _byLang = {
    'ko': [
      ...
      '도파민 부족하면\n남 한 번 도와보세요',
      '거슬리는 일은\n오늘 그냥 흘려보내요',
      '선행 하나 하고 나면\n기분이 거제 야호예요', // 거제 야호 - RESCENE 원이·미나미 밈, 2026.05~ (YTN 2026.06.08, namu.wiki)
      '복잡한 생각 다 접고\n오늘은 선행이나 해야겠다', // 파라파라(모르겠고 파라파라나 춰야겠다) 패러디 - RESCENE 미나미 밈, 2026.05~ (뉴스컬처 N프리즘)
      '실수는 코 때리고\n미안, 하면 끝이에요', // 코 때리고 미안해하는 챌린지 - 2026.05~ 릴스/틱톡 유행 (Trend A Word #560)
      '선행 패스하면\n솔직히 좀 쑥스바겐이죠', // 쑥스바겐(쑥스럽다+폭스바겐 말장난) - 2026년 신조어 모음 (Cookat매거진 카드뉴스)
    ],
    'en': [
