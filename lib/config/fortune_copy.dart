...
//  2026.05~07 신규(웹 검증, docs/copy-refresh.md 리서치 참고): 거제 야호,
//  파라파라("모르겠고 ~나 해야겠다" 리듬 패러디), 코 때리고 미안해하는 챌린지,
//  쑥스바겐(쑥스럽다 말장난), "나 ○○인데~" 자기소개 포맷.
//  럭키비키는 2026.02 기준 이미 "유행 지났다"고 명시한 출처가 있어 전량 삭제함.
//  새 유행어는 추측 말고 검색으로 확인.
...
class FortuneCopy {
  ...
  static const Map<String, List<List<String>>> _overallByLang = {
    'ko': [
      [
        ...
        '피라미드에도 악플 달려요.\n오늘 그 일도 그런 거고요',
        '걱정은 내일부터.\n이게 장항준적 사고',
        '오늘은 좀 쑥스바겐 데이.\n그래도 선행 하나는 가능해요', // 쑥스바겐(쑥스럽다+폭스바겐 말장난) - 2026년 신조어 모음 (Cookat매거진 카드뉴스)
      ],
      [
        '나쁘지 않아요.\n딱 평타',
        '무난무난.\n선행 하나면 상향 조정돼요',
        ...
        '나쁘지 않은데요?\n이 정도면 좋다~ 🤙',
        '선행 하나면 올라간다\n그러더라고요',
        '복잡하게 생각하지 말고\n선행이나 하나 해요', // 파라파라(모르겠고~) 패러디 - RESCENE 미나미 밈, 2026.05~ (뉴스컬처 N프리즘)
      ],
      [
        '오늘 꽤 맑아요.\n좋은 일 예감',
        '행운 신호등,\n초록불 들어왔어요',
        ...
        '오늘 컨디션,\n주인공 각이에요',
        '착한 일 하면 이자 붙는다\n그러더라고요',
        '이 정도 운이면\n거제 야호 각이에요', // 거제 야호 - RESCENE 원이·미나미 밈, 2026.05~ (YTN 2026.06.08)
      ],
      [
        '운세 만렙 근접.\n뭐든 되는 날이에요',
        '이 정도면\n사방이 네잎클로버예요',
        ...
        '오늘 운세\n난리자베스',
        '오늘 얼마나 잘될지\n감도 안 오네요',
        '나 오늘 운 최고치\n찍은 사람인데요~', // "나 ○○인데~" 자기소개 밈 - 2026.06 최신 밈 (고구마팜)
      ],
    ],
    'en': [
      [
  ...
  static const Map<String, List<String>> _adviceByLang = {
    'ko': [
      ...
      '실수한 사람은 코 때리고 미안 챌린지처럼 가볍게 웃어넘겨요', // 코 때리고 미안해하는 챌린지 - 2026.05~ 릴스/틱톡 유행 (Trend A Word #560)
      '복잡하게 생각 말고 옆 사람부터 도와줘요', // 파라파라(모르겠고~) 패러디 - RESCENE 미나미 밈, 2026.05~ (뉴스컬처 N프리즘)
    ],
    'en': [
